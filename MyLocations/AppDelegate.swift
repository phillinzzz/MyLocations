...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if let tableViewControllers = tabController.viewControllers {
            ...
            let _ = controller2.fetchedResultsController
            // Third tab
    ...
    func listenForFatalCoreDataNotifications() {
        ...
        NotificationCenter.default.addObserver(forName: CoreDataSaveFailedNotification, object: nil, queue: nil, using: {
            notification in
            let message = """
There is a fatal error in the app and it cannot continue.

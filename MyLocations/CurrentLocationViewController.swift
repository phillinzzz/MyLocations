...
class CurrentLocationViewController: UIViewController, CLLocationManagerDelegate, CAAnimationDelegate {
    ...
    func showLocationServiceDeniedAlert() {
        let alert = UIAlertController(title: "Location Services Disabled", message: "Please enable loaction services for this app in Settings.", preferredStyle: .alert)
    ...
    func hideLogoView() {
        ...
        logoButton.layer.add(logoRotator, forKey: "logoRotaror")

...
class LocationDetailsViewController : UITableViewController {
    ...
    // MARK:- Actions
    @IBAction func done() {
        //"view"(self.view) here is NOT the same as "navigationController!.view" , "navigationController!.view" is ("view" + the navigation bar)
    ...
    func show(image: UIImage) {
        ...
        let imageViewHeight = 260 / (image.size.width / image.size.height)
        imageView.frame = CGRect(x: 10, y: 10, width: 260, height: imageViewHeight)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.section == 0 && indexPath.row == 0 {
            ...
            //The simulator doesnt have a camera so the app will crash! use choose photo from library instead
            //takePhotoWithCamera()
